 ...
 */
export type Meta<TArgs = Args> = ComponentAnnotations<PixiFramework, TArgs>;
 ...
 */
export type StoryFn<TArgs = Args> = AnnotatedStoryFn<PixiFramework, TArgs>;
 ...
 * @see [Named Story exports](https://storybook.js.org/docs/formats/component-story-format/#named-story-exports)
 */
export type StoryObj<TArgs = Args> = StoryAnnotations<PixiFramework, TArgs>;
